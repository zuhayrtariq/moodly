    ...
    <div className="flex flex-col gap-2">
      <div className="grid grid-cols-5 gap-4">
        <button
          ...
          className="mr-auto text-orange-400 text-lg sm:text-xl duration-200 hover:opacity-60"
        >
        ...
        <button
          ...
          className="ml-auto text-orange-400 text-lg sm:text-xl duration-200 hover:opacity-60"
        >
            ...
            <div key={rowIndex} className="grid grid-cols-7 gap-1">
              {dayList.map((dayOfWeek, dayOfWeekIndex) => {
                ...
                let color = demo
                  ...
                  : dayIndex in data
                  ? gradients.orange[data[dayIndex]]
                  : "white";
                ...
                return (
                  <div
                    ...
                    className={
                      ...
                      (color === "white" ? " text-orange-400" : " text-white")
                    }
                    key={dayOfWeekIndex}
                  >
                    <p>{dayIndex}</p>
